#!/usr/bin/env python3
"""Run the coupled thermal-hydraulics + fuel behaviour LOCA calculation.

Simulates a Loss-of-Coolant Accident (LOCA) in a PWR for 600 seconds.
Reference: MATLAB Module 09 (Thermal.Hydraulics)
"""
...
from orpheus.thermal_hydraulics.solver import solve_thermal_hydraulics
